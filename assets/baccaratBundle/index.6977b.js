...
System.register("chunks:///_virtual/BaccaratAutoSettingView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseAutoSettingView.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, BaseAutoSettingView;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BaccaratAutoSettingView = exports('BaccaratAutoSettingView', (_dec = ccclass('BaccaratAutoSettingView'), _dec(_class = /*#__PURE__*/function (_BaseAutoSettingView) {
          ...
          for (var i = 0; i < roadFragment.length; i++) {
            ...
            for (var j = 0; j < cells.length; j++) {
              ...
              if (j < rowCount) {
                ...
                pos = v3(config.startPos.x + i + (rowCount - j + 1) * config.verticalSpacing, config.startPos.y + rowCount * config.horizontalSpacing);
              }
...
System.register("chunks:///_virtual/BaccaratTableController.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableController.ts', './bc_baccarat.ts', './BaccaratTableBetView.ts', './PlayerMgr.ts', './NumberFormatUtil.ts', './BaccaratMainGameView.ts', './Logger.ts', './PopupMgr.ts'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, BaseTableController, Phase, BaccaratTableBetView, PlayerMgr, NumberFormatUtil, BaccaratMainGameView, Logger, PopupMgr;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
        ...
        _proto.thirdShowCards = function thirdShowCards(isShowBack) {
          ...
          if (cardsInfo.bankerCards[2]) {
            tween(bankerAddCard.node).to(BaccaratConsts.showCardTime, {
              ...
              bankerAddCard.setCard(cardsInfo.playerCards[2], isShowBack);
