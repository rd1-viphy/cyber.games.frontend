System.register("chunks:///_virtual/BacaraCustomRoadLogic.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaccaratEnum.ts', './BacaratAutoLogic.ts', './proccessor.ts', './BaccaratData.ts'], function (exports) {
  var _inheritsLoose, _createClass, cclegacy, _decorator, Component, BaccaratBetType, BaccaratAutoLogic, bigRoadPreProcess, BaccaratRoadConfig, SeekBankerRoadInfoData, SeekPlayerRoadInfoData;
  return {
    ...
    execute: function () {
      ...
      var BacaraCustomRoadLogic = exports('BacaraCustomRoadLogic', (_dec = ccclass('BacaraCustomRoadLogic'), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function BacaraCustomRoadLogic() {
          ...
          _this._maxLine = BaccaratRoadConfig.customBigRoad.rowCount;
          _this._maxCeil = BaccaratRoadConfig.customBigRoad.colCount;
          return _this;
        }
...
System.register("chunks:///_virtual/BacaraCustomRoadView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BacaraCustomRoadLogic.ts', './BaccaratEnum.ts', './BaccardTableRoadItem.ts', './BaccaratData.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, ToggleContainer, Prefab, instantiate, v3, Animation, Component, BacaraCustomRoadLogic, BaccaratBetType, BaccardTableRoadItem, BaccaratRoadConfig;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var BacaraCustomRoadView = exports('BacaraCustomRoadView', (_dec = ccclass('BacaraCustomRoadView'), _dec2 = property(Node), _dec3 = property(ToggleContainer), _dec4 = property(Prefab), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.refreshRoadView = function refreshRoadView() {
          ...
          var config = BaccaratRoadConfig.customBigRoad;
...
System.register("chunks:///_virtual/BaccaraTableSettleView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableSettleView.ts', './BaccaratData.ts', './NumberFormatUtil.ts', './BacaratAutoLogic.ts', './AudioManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Sprite, SpriteFrame, Color, BaseTableSettleView, BaccaratEvents, BaccaratRoundResultType, BaccaratSelfResultType, NumberFormatUtil, BaccaratAutoLogic, AudioManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BaccaratBettingState.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseState.ts', './BaccaratTableBetView.ts', './BaccaratMainGameView.ts', './BaccaratTableTipView.ts', './BaccaratData.ts', './AudioManager.ts'], function (exports) {
  var _inheritsLoose, cclegacy, BaseState, BaccaratTableBetView, BaccaratMainGameView, BaccaratTableTipView, BaccaratStatusTip, AudioManager;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/baccaratBundle", ['./BaccaratBettingState.ts', './BaccaratDealCardState.ts', './BaccaratGame2.ts', './BaccaratGameTale.ts', './BaccaratOpenCardState.ts', './BaccaratPrepareState.ts', './BaccaratSettleState.ts', './BaccaratStopBetState.ts', './BaccaratTableController.ts', './BacaraCustomRoadLogic.ts', './BacaratAutoLogic.ts', './BacaratInterface.ts', './BaccaratData.ts', './BaccaratEnum.ts', './BaccaratTableModel.ts', './BaccaratTableProxy.ts', './BacaraCustomRoadView.ts', './BaccaraTableSettleView.ts', './BaccaratAutoSettingView.ts', './BaccaratMainGameView.ts', './BaccaratRoadMapView.ts', './BaccaratTableBetView.ts', './BaccaratTableCardView.ts', './BaccaratTableChipView.ts', './BaccaratTableTipView.ts', './BaccaratVerifyCardView.ts', './BaccartAutoBetSettingNode.ts', './BaccartAutoSeekRoadSettingNode.ts', './BaccardTableBigEyesRoadItem.ts', './BaccardTableBigRoadItem.ts', './BaccardTableCockroachRoadItem.ts', './BaccardTableCubeRoadItem.ts', './BaccardTableRoadItem.ts', './BaccardTableSmallRoadItem.ts', './BaccaratGame.ts'], function () {
  return {
  ...
  return {
    ...
    execute: function () {
      ...
      var BaccaratEvents = exports('BaccaratEvents', {
        ...
        //刷新自己的结果
        RefreshRoadInfo: 'RefreshRoadInfo',
        //刷新路線資訊
        RefreshAutoBtnStatus: 'RefreshAutoBtnStatus' //刷新自動下注狀態
      });
      ...
      var BaccaratRoundResultType = exports('BaccaratRoundResultType', ['平侷', '莊贏', '閒贏']);
      ...
      var LocalStorageKey = exports('LocalStorageKey', {
        Bac_AutoBetOption: 'Bac_AutoBetOption',
        Bac_CustomSeekRoad: 'Bac_CustomSeekRoad',
        Bac_AutoSeekRoadOption: 'Bac_AutoSeekRoadOption'
      });
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/BaccaratMainGameView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseMainGameView.ts', './BaccaratTableBetView.ts', './PlayerMgr.ts', './BaccaratData.ts', './BaccaratEnum.ts', './GameClock.ts', './NumberFormatUtil.ts', './BaseMenuView.ts', './BaseAllCardVerifyInfoView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Sprite, SpriteFrame, BaseMainGameView, BaccaratTableBetView, PlayerMgr, BaccaratEvents, BaccaratBetBtn, GameClock, NumberFormatUtil, BaseMenuView, BaseAllCardVerifyInfoView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BaccaratStopBetState.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseState.ts', './BaccaratTableTipView.ts', './BaccaratData.ts', './AudioManager.ts'], function (exports) {
  var _inheritsLoose, cclegacy, BaseState, BaccaratTableTipView, BaccaratStatusTip, AudioManager;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/BaccaratTableBetView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableBetView.ts', './bc_baccarat.ts', './BaccaratData.ts', './BaccaratMainGameView.ts', './NumberFormatUtil.ts', './BacaratAutoLogic.ts', './BaccaratEnum.ts', './AudioManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Toggle, BaseTableBetView, BetType, BaccaratEvents, BaccaratMainGameView, NumberFormatUtil, BaccaratAutoLogic, BaccaratBetType, AudioManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BaccaratTableCardView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableCardView.ts', './BaccaratEnum.ts', './Utils.ts', './BaccaratData.ts', './AudioManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, BaseTableCardView, BaccaratCardIndex, Utils, BaccaratConsts, AudioManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      var BaccaratTableCardView = exports('BaccaratTableCardView', (_dec = ccclass('BaccaratTableCardView'), _dec2 = property({
        ...
        _proto.startOpenCard = /*#__PURE__*/function () {
          var _startOpenCard = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var cardsInfo, playerPoint, bankerPoint;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 12:
                  playerPoint = this.gameTable.tableModel.getCardsPoint([cardsInfo.playerCards[0], cardsInfo.playerCards[1]]);
                  this.showPoint(playerPoint, null, true);
                  //第二次开牌
                  this.secondFlopCards();
                  _context.next = 17;
                  return Utils.sleep(BaccaratConsts.disCardTime);
                case 17:
                  bankerPoint = this.gameTable.tableModel.getCardsPoint([cardsInfo.bankerCards[0], cardsInfo.bankerCards[1]]);
                  this.showPoint(playerPoint, bankerPoint, false);
                ...
                case 23:
                  ...
                  return Utils.sleep(BaccaratConsts.disCardTime);
                case 26:
                  this.showPoint(cardsInfo.playerScore, 0, true);
                case 27:
                ...
                case 31:
                  ...
                  return Utils.sleep(BaccaratConsts.disCardTime);
                case 34:
                  this.showPoint(cardsInfo.playerScore, cardsInfo.bankerScore, false);
                case 35:
                case "end":
...
System.register("chunks:///_virtual/BaccaratTableController.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableController.ts', './bc_baccarat.ts', './BaccaratTableBetView.ts', './PlayerMgr.ts', './NumberFormatUtil.ts', './BaccaratMainGameView.ts', './Logger.ts', './Emitter.ts', './GlobalData.ts', './PopupMgr.ts', './LinkParasUtil.ts', './BaseReplayView.ts', './AudioManager.ts'], function (exports) {
  var _inheritsLoose, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, BaseTableController, Phase, BaccaratTableBetView, PlayerMgr, NumberFormatUtil, BaccaratMainGameView, Logger, Emitter, GlobalEvent, GlobalData, TipMessage, BacaratBetTypeName, PopupMgr, LinkParasUtil, BaseReplayView, AudioManager;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _asyncToGenerator = module.asyncToGenerator;
    ...
    execute: function () {
      ...
      var BaccaratTableController = exports('BaccaratTableController', (_dec = ccclass('BaccaratTableController'), _dec(_class = /*#__PURE__*/function (_BaseTableController) {
          ...
          var _joinTable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  //加入牌桌
                  tableId = ~~LinkParasUtil.getParameterValue("table");
                  _context.next = 3;
                  return this.gameTable.tableProxy.sendJoinTabelRequest({
                    tableId: tableId
                  }).then(function (tableJoinData) {
                    Emitter.emit(GlobalEvent.EVENT_GAME_INIT_VIDEO);
                    //設置數據
          ...
          var _requestBet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(betRequest) {
            ...
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  //TODO 限红和当前金额的判断
                  totalBetNum = betRequest.details.reduce(function (prev, cur) {
                    return prev + NumberFormatUtil.formatMoneyToNumber(cur.bet);
                  }, 0);
                  if (!(totalBetNum < this.gameTable.tableModel.personLimits[0])) {
                    _context3.next = 4;
                    break;
                  }
                ...
                case 4:
                  if (!(totalBetNum > this.gameTable.tableModel.personLimits[1])) {
                    _context3.next = 7;
                    break;
                  }
                  ...
                  return this.gameTable.tableProxy.sendGameBetRequest(betRequest).then(function (betResponse) {
                    ...
                    var _loop = function _loop(_i) {
                      ...
                      _this3.scheduleOnce(function () {
                        PopupMgr.instance.showToast(BacaratBetTypeName[failedDetails[_i].detail.type] + "\u4E0B\u6CE8\u5931\u6557");
                      }, 0.5 * _i);
                    };
        ...
        _proto.startRePlay = function startRePlay() {
          ...
          // 下注
          this.scheduleOnce(function () {}, discardTime);
          //开牌
          this.scheduleOnce(function () {}, discardTime + betTime);
          //结算
          this.scheduleOnce(function () {}, discardTime + betTime + openCardTime);
        };
        _proto.onDestroy = function onDestroy() {
...
System.register("chunks:///_virtual/BaccaratTableModel.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableModel.ts', './bc_baccarat.ts', './NumberFormatUtil.ts', './Emitter.ts', './BaccaratData.ts', './PlayerMgr.ts', './BacaratAutoLogic.ts'], function (exports) {
  var _inheritsLoose, _createClass, cclegacy, _decorator, BaseTableModel, WinnerType, Phase, NumberFormatUtil, Emitter, BaccaratEvents, PlayerMgr, BaccaratAutoLogic;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createClass = module.createClass;
...
System.register("chunks:///_virtual/BaccartAutoBetSettingNode.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BacaratAutoLogic.ts', './NumberFormatUtil.ts', './BaccaratEnum.ts', './PopupMgr.ts', './GlobalData.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Toggle, EditBox, Node, Component, BaccaratAutoLogic, NumberFormatUtil, BaccaratBetType, PopupMgr, TipMessage;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BaccartAutoSeekRoadSettingNode.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BacaratAutoLogic.ts', './NumberFormatUtil.ts', './BaccaratEnum.ts', './PopupMgr.ts', './GlobalData.ts', './BacaraCustomRoadLogic.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Toggle, EditBox, Node, Component, BaccaratAutoLogic, NumberFormatUtil, BaccaratBetType, PopupMgr, TipMessage, BacaraCustomRoadLogic;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
