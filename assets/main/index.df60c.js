...
System.register("chunks:///_virtual/LauncherScene.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './pitaya_proto_wasm.ts', './NetConnect.ts', './LoadResNode.ts', './ClientEnum.ts', './LinkParasUtil.ts', './GameConfig.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, BufferAsset, view, ResolutionPolicy, Component, profiler, director, initSync, NetConnect, LoadResNode, Scenes, BundleName, LinkParasUtil, GameConfig;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
