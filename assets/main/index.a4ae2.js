    ...
    execute: function () {
      ...
      var AssetsMgr = exports('AssetsMgr', /*#__PURE__*/function () {
        ...
        AssetsMgr.loadRemoteJson = function loadRemoteJson(jsonName, cb) {
          assetManager.loadRemote(GameConfig.gameConfig.HTTP_URL + jsonName, function (err, jsonAset) {
            if (err) {
...
System.register("chunks:///_virtual/BaseBtnTouchListence.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AudioManager.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Node, Button, Component, AudioManager;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "12e60rShMlPlrIKeIOyHk7v", "BaseBtnTouchListence", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BaseBtnTouchListence = exports('BaseBtnTouchListence', (_dec = ccclass('BaseBtnTouchListence'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inheritsLoose(BaseBtnTouchListence, _Component);
        function BaseBtnTouchListence() {
          return _Component.apply(this, arguments) || this;
        }
        var _proto = BaseBtnTouchListence.prototype;
        _proto.onLoad = function onLoad() {
          var _this = this;
          this.node.on(Node.EventType.TOUCH_END, function () {
            if (_this.getComponent(Button) && _this.getComponent(Button).interactable) {
              AudioManager.playSound('ClickBtn');
            }
          }, this);
        };
        return BaseBtnTouchListence;
      }(Component)) || _class));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/BaseCardVerifyView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './CardItem.ts', './Utils.ts', './BaseAllCardVerifyInfoView.ts', './Emitter.ts', './GlobalData.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Node, Button, BaseTableView, CardItem, Utils, BaseAllCardVerifyInfoView, Emitter, GlobalEvent;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var BaseCardVerifyView = exports('BaseCardVerifyView', (_dec = ccclass('BaseCardVerifyView'), _dec2 = property([CardItem]), _dec3 = property([Label]), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTableView) {
        ...
        // protected regeistEvents: ListenerInfo[] = [{
        //     eventName:GlobalEvent.EVENT_GAME_SHOW_VERIFY_INFO,
        //     method: this.showCardVerifyInfo,
        //     caller: this
        // }];
        ;
...
System.register("chunks:///_virtual/BaseMainGameView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './Logger.ts', './BaseMenuView.ts', './BaseChipSettingView.ts', './BaseAutoSettingView.ts', './AudioManager.ts', './BaseBtnTouchListence.ts', './ChipItem.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Button, Label, BaseTableView, Logger, BaseMenuView, BaseChipSettingView, BaseAutoSettingView, AudioManager, BaseBtnTouchListence, ChipItem;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      BaseBtnTouchListence = module.BaseBtnTouchListence;
    }, function (module) {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BaseMainGameView = exports('BaseMainGameView', (_dec = ccclass('BaseMainGameView'), _dec2 = property(Node), _dec3 = property(Button), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTableView) {
        ...
        function BaseMainGameView() {
          ...
          _initializerDefineProperty(_this, "rootNode", _descriptor6, _assertThisInitialized(_this));
          return _this;
        }
        ...
        _proto.onLoad = function onLoad() {
          ...
          if (this.rootNode) {
            this.rootNode.walk(function (element) {
              if (element.getComponent(Button) && !element.getComponent(ChipItem)) {
                element.addComponent(BaseBtnTouchListence);
              }
            });
          }
        };
            ...
            case 'bet':
              {
                ...
                AudioManager.playSound('ConfirmBet');
                break;
              }
            case 'cancle':
              {
                this.cancleBetData();
                AudioManager.playSound('ClearBet');
                break;
              }
            case 'again':
              {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "rootNode", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
    ...
    execute: function () {
      ...
      var BaseMenuView = exports('BaseMenuView', (_dec = ccclass('BaseMenuView'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTableView) {
        ...
        _proto.showTableInfo = function showTableInfo(tableName, roundId, limit) {
          this.userNameLabel.string = PlayerMgr.instance.profile.nickname;
          this.tableNameLabel.string = tableName;
          this.roundNumLabel.string = roundId;
...
System.register("chunks:///_virtual/BaseRecordView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './NetConnect.ts', './DateUtils.ts', './BetRecordItem.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, EditBox, Toggle, Label, ScrollView, Prefab, Button, instantiate, BaseTableView, NetConnect, DateUtils, BetRecordItem;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      DateUtils = module.DateUtils;
    }, function (module) {
      BetRecordItem = module.BetRecordItem;
    }],
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BaseRecordView = exports('BaseRecordView', (_dec = ccclass('BaseRecordView'), _dec2 = property(EditBox), _dec3 = property(Toggle), _dec4 = property(Toggle), _dec5 = property([Label]), _dec6 = property([Label]), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(ScrollView), _dec10 = property(Prefab), _dec11 = property(Label), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTableView) {
        ...
        function BaseRecordView() {
          ...
          _this = _BaseTableView.call.apply(_BaseTableView, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "roundEditBox", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "startDateToggle", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "endDateToggle", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "startDateLabels", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "endDateLabels", _descriptor5, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "selectedStartDateLabel", _descriptor6, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "selectedEndDateLabel", _descriptor7, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "recordScrollview", _descriptor8, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "betRecordPrefab", _descriptor9, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "roundLabel", _descriptor10, _assertThisInitialized(_this));
          _this.maxPageNum = 10;
          _this._selectedStartDateIndex = 0;
          _this._selectedEndDateIndex = 0;
        ...
        _proto.updateView = function updateView() {};
        _proto.start = function start() {
          this.refreshDateLabelsShow();
          this.todaySelected();
        };
        _proto.refreshDateLabelsShow = function refreshDateLabelsShow() {
          var twoWeekDays = DateUtils.getTwoWeeksDates();
          this.startDateLabels.forEach(function (label, index) {
            label.string = twoWeekDays[index] + " 00:00:00";
          });
          this.endDateLabels.forEach(function (label, index) {
            label.string = twoWeekDays[index] + " 23:59:59";
          });
        };
        _proto.refreshDateLabelsState = function refreshDateLabelsState() {
          var _this2 = this;
          this.selectedStartDateLabel.string = this.startDateLabels[this._selectedStartDateIndex].string;
          this.selectedEndDateLabel.string = this.endDateLabels[this._selectedEndDateIndex].string;
          this.startDateLabels.forEach(function (label, index) {
            label.getComponent(Button).interactable = index <= _this2._selectedEndDateIndex;
          });
          this.endDateLabels.forEach(function (label, index) {
            label.getComponent(Button).interactable = index >= _this2._selectedStartDateIndex;
          });
          this.startDateToggle.isChecked = false;
          this.endDateToggle.isChecked = false;
        };
        _proto.startDatSelectBtnClick = function startDatSelectBtnClick(_, data) {
          var selectIndex = parseInt(data);
          this._selectedStartDateIndex = selectIndex;
          this.refreshDateLabelsState();
        };
        _proto.endDatSelectBtnClick = function endDatSelectBtnClick(_, data) {
          var selectIndex = parseInt(data);
          this._selectedEndDateIndex = selectIndex;
          this.refreshDateLabelsState();
        };
        _proto.dateToggleClick = function dateToggleClick(_, data) {
          switch (data) {
            case 'today':
              this.todaySelected();
              break;
            case 'yesterday':
              this.yesterdaySelected();
              break;
            case 'currentWeek':
              this.currentWeekSelected();
              break;
            case 'lastWeek':
              this.lastWeekSelected();
              break;
          }
        };
        _proto.todaySelected = function todaySelected() {
          this._selectedStartDateIndex = this.startDateLabels.length - 1;
          this._selectedEndDateIndex = this.endDateLabels.length - 1;
          this.refreshDateLabelsState();
          this.requestRecordByDate();
        };
        _proto.yesterdaySelected = function yesterdaySelected() {
          this._selectedStartDateIndex = this.startDateLabels.length - 2;
          this._selectedEndDateIndex = this.endDateLabels.length - 2;
          this.refreshDateLabelsState();
          this.requestRecordByDate();
        };
        _proto.currentWeekSelected = function currentWeekSelected() {
          var currentWeekDays = DateUtils.getCurrentWeekDates();
          var twoWeekDays = DateUtils.getTwoWeeksDates();
          this._selectedStartDateIndex = twoWeekDays.indexOf(currentWeekDays[0]);
          this._selectedEndDateIndex = twoWeekDays.indexOf(currentWeekDays[currentWeekDays.length - 1]);
          this.refreshDateLabelsState();
          this.requestRecordByDate();
        };
        _proto.lastWeekSelected = function lastWeekSelected() {
          var lastWeek = DateUtils.getLastWeekDates();
          var twoWeekDays = DateUtils.getTwoWeeksDates();
          this._selectedStartDateIndex = twoWeekDays.indexOf(lastWeek[0]);
          this._selectedEndDateIndex = twoWeekDays.indexOf(lastWeek[lastWeek.length - 1]);
          this.refreshDateLabelsState();
          this.requestRecordByDate();
        };
        _proto.searchBtnClicked = function searchBtnClicked() {
          if (this.roundEditBox.string) {
            this.requestRecordByRound();
          } else {
            this.requestRecordByDate();
          }
        };
        _proto.firstPageButtonClicked = function firstPageButtonClicked() {
          if (this._totalPage > 1 && this._currentPage > 1) {
            this.requestRecordByDate();
          }
        };
        _proto.lastPageButtonClicked = function lastPageButtonClicked() {
          if (this._totalPage > 1 && this._currentPage < this._totalPage) {
            this.requestRecordByDate();
          }
        };
        _proto.previousPageButtonClicked = function previousPageButtonClicked() {
          if (this._currentPage > 1) {
            this._currentPage--;
            this.requestRecordByDate();
          }
        };
        _proto.nextPageButtonClicked = function nextPageButtonClicked() {
          if (this._currentPage < this._totalPage) {
            this._currentPage++;
            this.requestRecordByDate();
          }
        };
        _proto.requestRecordByRound = function requestRecordByRound() {
          var _this3 = this;
          var request = {
            roundId: this.roundEditBox.string,
            page: this._currentPage,
            limit: this.maxPageNum
          };
          NetConnect.sendRequest('public.game_record.listbyround', request).then(function (response) {
            _this3.refreshRecordContent(response);
          });
        };
        _proto.requestRecordByDate = function requestRecordByDate() {
          var _this4 = this;
          var request = {
            begin: DateUtils.convertDateToRFC3339(this.startDateLabels[this._selectedStartDateIndex].string),
            end: DateUtils.convertDateToRFC3339(this.endDateLabels[this._selectedEndDateIndex].string),
            page: this._currentPage,
            limit: this.maxPageNum
          };
          NetConnect.sendRequest('public.game_record.list', request).then(function (response) {
            _this4.refreshRecordContent(response);
          });
        };
        _proto.refreshRecordContent = function refreshRecordContent(response) {
          //刷新頁數數據
          this._totalPage = Math.ceil(response.count / this.maxPageNum);
          this.roundLabel.string = (this._totalPage == 0 ? 0 : this._currentPage) + "/" + this._totalPage;
          //刷新記錄內容
          this.recordScrollview.content.removeAllChildren();
          var records = response.records;
          for (var index = 0; index < records.length; index++) {
            var element = records[index];
            var recordNode = instantiate(this.betRecordPrefab);
            this.recordScrollview.content.addChild(recordNode);
            recordNode.getComponent(BetRecordItem).init(element);
          }
        };
        return BaseRecordView;
      }(BaseTableView), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "roundEditBox", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "startDateToggle", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "endDateToggle", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "startDateLabels", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "endDateLabels", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "selectedStartDateLabel", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "selectedEndDateLabel", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "recordScrollview", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "betRecordPrefab", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "roundLabel", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/BaseReplayView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, BaseTableView;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "05f23OYCXdBEKsrOWmKIZbn", "BaseReplayView", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BaseReplayView = exports('BaseReplayView', (_dec = ccclass('BaseReplayView'), _dec(_class = /*#__PURE__*/function (_BaseTableView) {
        _inheritsLoose(BaseReplayView, _BaseTableView);
        function BaseReplayView() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
        ...
        var _proto = BaseReplayView.prototype;
        _proto.initView = function initView() {};
        _proto.updateView = function updateView() {};
        _proto.backBtnClicked = function backBtnClicked() {};
        return BaseReplayView;
      }(BaseTableView)) || _class));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/BaseSoundSettingView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './AudioManager.ts', './GlobalData.ts', './Emitter.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Toggle, ProgressBar, Slider, sys, BaseTableView, AudioManager, GlobalLocalStrogeKey, GlobalEvent, Emitter;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      GlobalLocalStrogeKey = module.GlobalLocalStrogeKey;
      GlobalEvent = module.GlobalEvent;
    }, function (module) {
      Emitter = module.Emitter;
    }],
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BaseSoundSettingView = exports('BaseSoundSettingView', (_dec = ccclass('BaseSoundSettingView'), _dec2 = property({
        type: Toggle,
        tooltip: "音乐总开关"
      }), _dec3 = property({
        type: ProgressBar,
        ...
        function BaseSoundSettingView() {
          ...
          _this = _BaseTableView.call.apply(_BaseTableView, [this].concat(args)) || this;
          _this.gameTable = void 0;
          _initializerDefineProperty(_this, "musicToggle", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "musicProgressBar", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "musicSlider", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "soundToggle", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "soundProgressBar", _descriptor5, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "soundSlider", _descriptor6, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "liveSoundToggle", _descriptor7, _assertThisInitialized(_this));
          return _this;
        }
        ...
        _proto.start = function start() {
          ...
          var soundVolume = AudioManager.getSoundVolume();
          this.musicToggle.isChecked = musicVolume > 0;
          this.soundToggle.isChecked = soundVolume > 0;
          this.musicProgressBar.progress = musicVolume;
          this.soundProgressBar.progress = soundVolume;
          this.musicSlider.progress = musicVolume;
          this.soundSlider.progress = soundVolume;
        };
        _proto.onEnable = function onEnable() {
          var liveSoundStroge = sys.localStorage.getItem(GlobalLocalStrogeKey.Video_Mute);
          this.liveSoundToggle.isChecked = liveSoundStroge == "0";
        };
        _proto.sliderListener = function sliderListener(event, data) {
          switch (data) {
            case "music":
              var progress1 = event.progress;
              this.musicProgressBar.progress = progress1;
              this.musicToggle.isChecked = progress1 > 0;
              AudioManager.setMusicVolume(progress1);
              break;
            case "sound":
              var progress2 = event.progress;
              this.soundProgressBar.progress = progress2;
              this.soundToggle.isChecked = progress2 > 0;
              AudioManager.setSoundVolume(progress2);
              break;
          }
        };
        _proto.toggleListener = function toggleListener(event, data) {
          switch (data) {
            case "music":
              var musicVolume = this.musicToggle.isChecked ? 0 : 1;
              this.musicProgressBar.progress = musicVolume;
              this.musicSlider.progress = musicVolume;
              AudioManager.setMusicVolume(musicVolume);
              break;
            case "sound":
              var soundVolume = this.soundToggle.isChecked ? 0 : 1;
              this.soundProgressBar.progress = soundVolume;
              this.soundSlider.progress = soundVolume;
              AudioManager.setSoundVolume(soundVolume);
              break;
            case "liveSound":
              var liveSoundIsMute = this.liveSoundToggle.isChecked;
              Emitter.emit(GlobalEvent.EVENT_GAME_UPDATE_VIDEO_MUTE, liveSoundIsMute);
              break;
          }
        };
        return BaseSoundSettingView;
      }(BaseTableView), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "musicToggle", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "musicProgressBar", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "musicSlider", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "soundProgressBar", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "liveSoundToggle", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/BaseTableChipView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './ChipItem.ts', './NumberFormatUtil.ts', './GlobalData.ts', './AudioManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, BaseTableView, ChipItem, NumberFormatUtil, GlobalEvent, AudioManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var BaseTableChipView = exports('BaseTableChipView', (_dec = ccclass('BaseTableChipView'), _dec2 = property([ChipItem]), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTableView) {
        ...
        _proto.chipToggleClicked = function chipToggleClicked(_, data) {
          ...
          AudioManager.playSound('ClickChips');
        };
    ...
    execute: function () {
      ...
      var BaseTableModel = exports('BaseTableModel', (_dec = ccclass('BaseTableModel'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        function BaseTableModel() {
          ...
          /**每個人限額 */
          _this._personLimits = [2000, 100000];
          return _this;
        }
        ...
        _createClass(BaseTableModel, [{
          ...
          key: "personLimits",
          get: function get() {
            return this._personLimits;
          },
          set: function set(value) {
            this._personLimits = value;
          }
        }]);
...
System.register("chunks:///_virtual/BetRecordItem.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './NumberFormatUtil.ts', './DateUtils.ts', './GlobalData.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Color, Component, NumberFormatUtil, DateUtils, BacaratBetTypeName;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "20617M3o6dLvYhEwm+/Vswu", "BetRecordItem", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var BetRecordItem = exports('BetRecordItem', (_dec = ccclass('BetRecordItem'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(BetRecordItem, _Component);
        function BetRecordItem() {
          ...
          _initializerDefineProperty(_this, "roundAndTimeLabel", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "betTypeLabel", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "betCoinLabel", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "resultLabel", _descriptor5, _assertThisInitialized(_this));
          return _this;
        }
        var _proto = BetRecordItem.prototype;
        _proto.init = function init(record) {
          this.gameLabel.string = record.gameName + "\n" + record.tableName;
          this.roundAndTimeLabel.string = record.roundId + "\n" + DateUtils.rfcConvertDateToString(record.date);
          this.betTypeLabel.string = "" + BacaratBetTypeName[record.betType];
          this.betCoinLabel.string = NumberFormatUtil.formatMoneyToNumber(record.bet).toString();
          var result = NumberFormatUtil.formatMoneyToNumber(record.settle);
          this.resultLabel.string = result > 0 ? "+" + result : "" + result;
          this.resultLabel.color = result > 0 ? Color.GREEN : Color.RED;
        };
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "roundAndTimeLabel", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "betTypeLabel", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "betCoinLabel", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
  ...
  return {
    ...
    execute: function () {
      ...
      var Code = exports('Code', /*#__PURE__*/function (Code) {
        ...
        Code[Code["InvalidToken"] = 1002] = "InvalidToken";
        Code[Code["TokenExpired"] = 1003] = "TokenExpired";
        ...
        Code[Code["BetLimitViolate"] = 1024] = "BetLimitViolate";
        Code[Code["KickoutByIdle"] = 1031] = "KickoutByIdle";
...
System.register("chunks:///_virtual/DateUtils.ts", ['cc'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
    ...
    execute: function () {
      cclegacy._RF.push({}, "d2f1fNcra1PFpEJ0fl5oJzl", "DateUtils", undefined);
      var DateUtils = exports('DateUtils', /*#__PURE__*/function () {
        function DateUtils() {}
        /**
        * 获取当天在内两周的日期数组
        * @returns 返回包含14天日期的数组，格式为 YYYY-MM-DD
        */
        DateUtils.getTwoWeeksDates = function getTwoWeeksDates() {
          var dates = [];
          var today = new Date();
          for (var i = 0; i < 14; i++) {
        ...
        /**
         * 获取本周的日期数组
         * @returns 返回本周的日期数组，格式为 YYYY-MM-DD
         */;
        DateUtils.getCurrentWeekDates = function getCurrentWeekDates() {
          var dates = [];
          var today = new Date();
          var currentDay = today.getDay(); // 0 是周日，1-6 是周一到周六
         ...
         * @returns 
         */;
        DateUtils.getTwoWeeksDatesBelongToCurrentWeek = function getTwoWeeksDatesBelongToCurrentWeek() {
          var twoWeekDays = this.getTwoWeeksDates();
          var currentWeekDays = this.getCurrentWeekDates();
          var includeWeekDays = currentWeekDays.filter(function (day) {
            return twoWeekDays.includes(day);
          });
        ...
        /**
         * 获取上周的日期数组
         * @returns 返回上周的日期数组，格式为 YYYY-MM-DD
         */;
        DateUtils.getLastWeekDates = function getLastWeekDates() {
          var dates = [];
          var today = new Date();
          ...
          lastMonday.setDate(today.getDate() - (currentDay === 0 ? 13 : currentDay + 6));

          // 获取上周的所有日期
          for (var i = 0; i < 7; i++) {
            var date = new Date(lastMonday);
        ...
        /**
          ...
          * @returns 
          */;
        DateUtils.getTwoWeeksDatesBelongToLastWeek = function getTwoWeeksDatesBelongToLastWeek() {
          var twoWeekDays = this.getTwoWeeksDates();
          var lastWeekDays = this.getLastWeekDates();
          var includeWeekDays = lastWeekDays.filter(function (day) {
            return twoWeekDays.includes(day);
          });
          return includeWeekDays;
        }
        /**
         * 將日期字符串轉換為 RFC3339 格式
         * @param dateStr 
         * @returns 
         */;
        DateUtils.convertDateToRFC3339 = function convertDateToRFC3339(dateStr) {
          var formattedDateStr = dateStr.replace('：', ':');
          var date = new Date(formattedDateStr);
          if (isNaN(date.getTime())) {
            throw new Error('输入的日期字符串格式不正确');
          }
          var offset = date.getTimezoneOffset();
          var offsetHours = Math.abs(Math.floor(offset / 60));
          var offsetMinutes = Math.abs(offset % 60);
          var offsetSign = offset <= 0 ? '+' : '-';
          var rfc3339 = date.toISOString().replace('Z', "" + offsetSign + String(offsetHours).padStart(2, '0') + ":" + String(offsetMinutes).padStart(2, '0'));
          return rfc3339;
        };
        DateUtils.rfcConvertDateToString = function rfcConvertDateToString(rfc3339) {
          var date = new Date(rfc3339);
          if (isNaN(date.getTime())) {
            throw new Error('输入的 RFC 3339 格式时间字符串不正确');
          }
          var month = String(date.getMonth() + 1).padStart(2, '0');
          var day = String(date.getDate()).padStart(2, '0');
...
System.register("chunks:///_virtual/GameClock.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AudioManager.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Sprite, Label, Component, AudioManager;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var GameClock = exports('GameClock', (_dec = ccclass('GameClock'), _dec2 = property({
        ...
        function GameClock() {
          ...
          _this.isPlayCountDownSound = false;
          return _this;
        }
        ...
        _proto.startClock = function startClock(currectTime, totalTime) {
          ...
          this.node.active = true;
          this.isPlay = true;
          this.isPlayCountDownSound = false;
        };
        ...
        _createClass(GameClock, [{
          ...
          set: function set(time) {
            if (this.clockLabel) {
              ...
              if (Math.ceil(time) === 3 && !this.isPlayCountDownSound) {
                this.isPlayCountDownSound = true;
...
System.register("chunks:///_virtual/GameGiftView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './AssetMgr.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Prefab, sp, BaseTableView, AssetsMgr;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3;
      cclegacy._RF.push({}, "6eae5ehcldAuZWRtVUdeLhT", "GameGiftView", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var GameGiftView = exports('GameGiftView', (_dec = ccclass('GameGiftView'), _dec2 = property([Node]), _dec3 = property(Prefab), _dec4 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseTableView) {
        _inheritsLoose(GameGiftView, _BaseTableView);
        function GameGiftView() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _BaseTableView.call.apply(_BaseTableView, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "giftContentNodes", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "giftItemPrefab", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "showGiftNode", _descriptor3, _assertThisInitialized(_this));
          _this.gameTable = void 0;
          return _this;
        }
        var _proto = GameGiftView.prototype;
        _proto.initView = function initView() {
          this.clearGiftContent();
          this.showGiftNode.removeAllChildren();
        };
        _proto.updateView = function updateView() {
          this.showGiftContent();
        };
        _proto.clearGiftContent = function clearGiftContent() {
          for (var index = 0; index < this.giftContentNodes.length; index++) {
            var content = this.giftContentNodes[index];
            content.removeAllChildren();
          }
        };
        _proto.showGiftContent = function showGiftContent() {};
        _proto.giftItemSelected = function giftItemSelected() {
          //其他item 不被選中
        };
        _proto.sendGiftItem = function sendGiftItem() {
          //發送禮物請求
        };
        _proto.showGiftEffect = function showGiftEffect(spineName) {
          var spineNode = new Node();
          this.showGiftNode.addChild(spineNode);
          spineNode.addComponent(sp.Skeleton);
          //加載spine動畫
          AssetsMgr.loadSkeletonData("gift/" + spineName).then(function (skeletonData) {
            spineNode.getComponent(sp.Skeleton).skeletonData = skeletonData;
        ...
        return GameGiftView;
      }(BaseTableView), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "giftContentNodes", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "giftItemPrefab", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "showGiftNode", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/GameVideoView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './TCLivePlayer.ts', './Emitter.ts', './GlobalData.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Toggle, Node, sys, game, view, UITransform, Component, TCLivePlayer, Emitter, GlobalEvent, GlobalLocalStrogeKey;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var GameVideoView = exports('GameVideoView', (_dec = ccclass('GameVideoView'), _dec2 = property(Toggle), _dec3 = property(Toggle), _dec4 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.onLoad = function onLoad() {
          Emitter.on(GlobalEvent.EVENT_GAME_INIT_VIDEO, this.initVideo, this);
          Emitter.on(GlobalEvent.EVENT_GAME_UPDATE_VIDEO_MUTE, this.updateVideoMute, this);
          //刷新視頻開關和mute開關
          this.muteToggle.isChecked = sys.localStorage.getItem(GlobalLocalStrogeKey.Video_Mute) != "0";
          this.playToggle.isChecked = sys.localStorage.getItem(GlobalLocalStrogeKey.Video_Close) != "0";
          this.videoMask.active = this.playToggle.isChecked;
        };
        _proto.initVideo = function initVideo() {
        ...
        _proto.createVideoDom = function createVideoDom(videoId) {
          ...
          this.video.muted = this.muteToggle.isChecked; // 静音
          this.video.autoplay = !this.playToggle.isChecked; // 自动播放
          //this.setVideoPos();
        ...
        _proto.setVideoPos = function setVideoPos() {
          ...
          var worldPos = this.videoMask.worldPosition;
          this.video.style.top = realSize.height - worldPos.y - this.videoMask.getComponent(UITransform).height / 2 + 'px';
          // this.video.style.left = worldPos.x + 'px';
          // this.video.style.top = worldPos.y + 'px'; 
          ...
          //     //宽度
          //     this.video.style.width = "100%";
          //     let prop = realSize.width / view.getDesignResolutionSize().width;
          ...
          // } else {
          //     //高度
          //     let prop = realSize.height / view.getDesignResolutionSize().height;
          //     let width = realSize.height / view.getDesignResolutionSize().height * 720;
          ...
          //     this.video.style.top = (prop * 80) + 'px';
          // }
        };

        _proto.setVideoMute = function setVideoMute(isMute) {
          this.video.muted = isMute;
          sys.localStorage.setItem(GlobalLocalStrogeKey.Video_Mute, isMute ? "1" : "0");
        };
        _proto.setVideoPlay = function setVideoPlay(isPlay) {
          ...
          sys.localStorage.setItem(GlobalLocalStrogeKey.Video_Close, isPlay ? "0" : "1");
        };
        ...
        _proto.updateVideoMute = function updateVideoMute(isMute) {
          this.setVideoMute(isMute);
          this.muteToggle.isChecked = isMute;
        };
        _proto.onDestroy = function onDestroy() {
          Emitter.off(GlobalEvent.EVENT_GAME_INIT_VIDEO, this.initVideo);
          Emitter.off(GlobalEvent.EVENT_GAME_UPDATE_VIDEO_MUTE, this.updateVideoMute);
        };
...
System.register("chunks:///_virtual/GiftItem.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Sprite, Label, Node, SpriteFrame, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5;
      cclegacy._RF.push({}, "7d795ek4Y9IBaP3eFUt53yg", "GiftItem", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var GiftItem = exports('GiftItem', (_dec = ccclass('GiftItem'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property([SpriteFrame]), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(GiftItem, _Component);
        function GiftItem() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          ...
          _this = _Component.call.apply(_Component, [this].concat(args)) || this;
          _initializerDefineProperty(_this, "giftIcon", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "nameLabel", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "coinLabel", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "selectBtn", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "iconSpriteFrames", _descriptor5, _assertThisInitialized(_this));
          return _this;
        }
        var _proto = GiftItem.prototype;
        _proto.init = function init(data) {};
        _proto.setSelectBtnActive = function setSelectBtnActive(active) {
          this.selectBtn.active = active;
        };
        _proto.selectBtnClicked = function selectBtnClicked() {
          this.setSelectBtnActive(true);
        };
        _proto.sendGiftBtnClicked = function sendGiftBtnClicked() {};
        return GiftItem;
      }(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "giftIcon", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "iconSpriteFrames", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
  ...
  return {
    ...
    execute: function () {
      ...
      var GlobalData = exports('GlobalData', {
        ...
        replayData: null,
        maxCoin: 99999999,
        GiftSpineName: ['danjiutao', 'egg', 'zhadan', 'bazhang', 'chuinixiongkou', 'tuoxie', 'bangbangtang', 'bindou', 'daxiaoren', 'yuanbao', 'feibiao', 'saqian', 'wushi', 'paoche', 'zhishengji', 'huojian', 'chun', 'caishen', '2025', 'fotiaoqiang', 'jigu', 'hongbao', 'fudai', 'dajidali']
      });
      var GlobalEvent = exports('GlobalEvent', {
        ...
        EVENT_GAME_INIT_VIDEO: 'event_game_init_video',
        EVENT_GAME_UPDATE_VIDEO_MUTE: 'event_game_update_video_mute'
      });
      ...
      var TipMessage = exports('TipMessage', {
        Start_Auto_Bet: "開始自動下注",
        Star_Auto_Seek_Road: "開始自動追路",
        Bet_Value_Less_Min: '下注金額小於最低限額',
        Bet_Value_Over_Max: '下注金額大於最多限額',
        Round_Value_Error: '局數設置錯誤',
        Please_Set_Road: '請先設置路圖',
        Kickout: '长时间未操作，即将离开游戏'
      });
      var BacaratBetTypeName = exports('BacaratBetTypeName', ['和', '莊免傭', '莊非免傭', '閒', '莊對', '閒對', '大', '小', '莊單', '莊雙', '閒單', '閒雙', '超級 6', '莊龍寶', '閒龍寶', '莊例牌', '閒例牌', '任意一對', '完美對子']);
      var GlobalLocalStrogeKey = exports('GlobalLocalStrogeKey', {
        Video_Close: 'Video_Close',
        //視頻開關
        Video_Mute: 'Video_Mute' //視頻靜音
      });
...
System.register("chunks:///_virtual/LauncherScene.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './pitaya_proto_wasm.ts', './NetConnect.ts', './LoadResNode.ts', './ClientEnum.ts', './GameConfig.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, BufferAsset, view, ResolutionPolicy, Component, profiler, director, initSync, NetConnect, LoadResNode, Scenes, BundleName, GameConfig;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/main", ['./ClientEnum.ts', './GameConfig.ts', './GamePackage.ts', './GlobalData.ts', './BaseState.ts', './StateMachineManager.ts', './BaseGameTale.ts', './BaseTableController.ts', './BaseTableModel.ts', './BaseTableProxy.ts', './BaseAllCardVerifyInfoView.ts', './BaseAutoSettingView.ts', './BaseCardVerifyView.ts', './BaseChipSettingView.ts', './BaseMainGameView.ts', './BaseMenuView.ts', './BaseRecordView.ts', './BaseReplayView.ts', './BaseRoadMapView.ts', './BaseSoundSettingView.ts', './BaseTableBetView.ts', './BaseTableCardView.ts', './BaseTableChipView.ts', './BaseTableSettleView.ts', './BaseTableTipView.ts', './BaseTableView.ts', './BetRecordItem.ts', './GameGiftView.ts', './BaseGame.ts', './I18nLabel.ts', './I18nMgr.ts', './I18nSprite.ts', './bigRoad.ts', './bottomRoad.ts', './cubeRoad.ts', './dragonIncubatePool.ts', './proccessor.ts', './roadFragment.ts', './roadInfo.ts', './AssetMgr.ts', './AudioManager.ts', './AudioRoot.ts', './BundleMgr.ts', './GameMgr.ts', './PlayerMgr.ts', './PopupMgr.ts', './Emitter.ts', './HttpUtils.ts', './NetConnect.ts', './Protocol.ts', './WebSocketClient.ts', './account.ts', './bc_baccarat.ts', './bc_niuniu.ts', './chat.ts', './code.ts', './finance.ts', './game.ts', './transaction.ts', './pitaya_proto_wasm.ts', './GameChatView.ts', './GameVideoView.ts', './TCLiveChat.ts', './TCLivePlayer.ts', './BaseBtnTouchListence.ts', './BetChipItem.ts', './CardItem.ts', './ChipItem.ts', './GameClock.ts', './GiftItem.ts', './SetChipItem.ts', './TipPopup.ts', './ToastPopup.ts', './VerifyCardItem.ts', './DateUtils.ts', './LinkParasUtil.ts', './Logger.ts', './NumberFormatUtil.ts', './Utils.ts', './LauncherScene.ts', './LoadResNode.ts'], function () {
  return {
                        ...
                        case 0:
                          ...
                          return _this.initClient().then( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                            ...
                            return _regeneratorRuntime().wrap(function _callee$(_context) {
                              while (1) switch (_context.prev = _context.next) {
                                case 0:
                                  token = LinkParasUtil.getParameterValue("token");
                                  vendor = ~~LinkParasUtil.getParameterValue("vendor"); //登录
                                  _context.next = 4;
...
System.register("chunks:///_virtual/PlayerMgr.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Emitter.ts', './NumberFormatUtil.ts'], function (exports) {
  var _createClass, cclegacy, Emitter, NumberFormatUtil;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
    }, function (module) {
    ...
    execute: function () {
      ...
      var PlayerMgr = exports('default', /*#__PURE__*/function () {
        function PlayerMgr() {
          ...
          this.avatar = "";
          this.id = "";
          Emitter.on("onProfileUpdate", this.onProfileUpdate, this);
        }
        ...
        _proto.onProfileUpdate = function onProfileUpdate(profileData) {
...
System.register("chunks:///_virtual/proccessor.ts", ['cc', './cubeRoad.ts', './bigRoad.ts', './bottomRoad.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      exports({
        bigRoadPreProcess: bigRoadPreProcess,
        roadPreProcess: roadPreProcess
      });
      ...
      function bigRoadPreProcess(request) {
        // big road 处理状态
        var bigRoadState = new BigRoadState(request.bigRoadRowCount);
        var roundCount = request.roadInfos.length;
        for (var i = 0; i < roundCount; i++) {
          var roadInfo = request.roadInfos[i];
          bigRoadState.process(roadInfo);
        }
        return bigRoadState.finish();
      }
      cclegacy._RF.pop();
    }
  };
      ...
      var TCLivePlayer = exports('TCLivePlayer', /*#__PURE__*/function () {
        function TCLivePlayer(videoId) {
          ...
          this.tcpPlayer = TCPlayer(videoId, {
            sources: ['https://1500009007.vod2.myqcloud.com/43864de0vodtranscq1500009007/2fb02795387702305297108918/v.f100280.m3u8']
          });
        }
...
System.register("chunks:///_virtual/transaction.ts", ['cc'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
    ...
    execute: function () {
      cclegacy._RF.push({}, "e2dd3vA9t9CNb0T8b4tt1qo", "transaction", undefined); // Code generated by protoc-gen-ts_proto. DO NOT EDIT.
      // versions:
      //   protoc-gen-ts_proto  v2.7.0
      //   protoc               v6.30.2
      ...
      /* eslint-disable */
      var protobufPackage = exports('protobufPackage', "protos");
      var TransactionStatus = exports('TransactionStatus', /*#__PURE__*/function (TransactionStatus) {
        TransactionStatus[TransactionStatus["Deduct"] = 0] = "Deduct";
        TransactionStatus[TransactionStatus["Refund"] = 1] = "Refund";
        TransactionStatus[TransactionStatus["Settle"] = 2] = "Settle";
