...
System.register("chunks:///_virtual/BaseMainGameView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './Logger.ts', './BaseMenuView.ts', './BaseChipSettingView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Button, Label, BaseTableView, Logger, BaseMenuView, BaseChipSettingView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/BaseMenuView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseTableView.ts', './PlayerMgr.ts', './BaseSoundSettingView.ts', './BaseRecordView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, BaseTableView, PlayerMgr, BaseSoundSettingView, BaseRecordView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
  ...
  return {
    ...
    execute: function () {
      ...
      var GameMgr = exports('GameMgr', ccclass(_class = /*#__PURE__*/function (_Component) {
        ...
        function () {
          var _disConnectTip = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var _this2 = this;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                ...
                case 6:
                  _context.sent.confirm(function () {
                    _this2.exitGame();
                  });
                case 7:
                case "end":
        ...
        _proto.maintenanceTip = /*#__PURE__*/function () {
          var _maintenanceTip = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var _this3 = this;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 2:
                  _context2.sent.confirm(function () {
                    _this3.exitGame();
                  });
                case 3:
                case "end":
...
System.register("chunks:///_virtual/LauncherScene.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './pitaya_proto_wasm.ts', './NetConnect.ts', './LoadResNode.ts', './ClientEnum.ts', './LinkParasUtil.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, BufferAsset, view, ResolutionPolicy, Component, director, initSync, NetConnect, LoadResNode, Scenes, BundleName, LinkParasUtil;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var NetConnect = exports('default', /*#__PURE__*/function () {
        ...
        NetConnect.initClient = function initClient() {
          var url = GameConfig.WS_URL;
          var protoUrl = GameConfig.PROTO_URL;
